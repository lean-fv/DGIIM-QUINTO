...
/**
 * Sets an optional base directory that is prepended to all output paths.
 * Must be called before cec17_init. Default: empty (write to current dir).
 * Example: cec17_set_base_dir("results_cec17") → results_cec17/results_BBO/...
 */
void cec17_set_base_dir(const char *basedir);
